...
export default function PainAndGain({ isOpen, setIsOpen, projectId }) {
              ...
              >
                <Dialog.Panel className="w-full max-w-2xl transform overflow-hidden rounded-2xl bg-white text-left align-middle shadow-xl transition-all">
                  <div className="px-6 py-6 lg:px-8">
                    ...
                    <p>
                      Berikut merupakan pain and gain yang sebelumnya kamu
                    ...
                    {sprintDatas &&
                      sprintDatas.map((sprintData, index) => (
                        <div
                          className="border border-4 border-dashed p-2 rounded-xl mt-4"
                          key={index}
                        >
