...
export default function SprintFive() {
    return (
        <>
            <header className="bg-white">
                <div className="mx-auto max-w-screen py-6 mx-4 md:mx-16">
                    <h1 className="text-3xl font-bold tracking-tight text-gray-900">Sprint Kelima</h1>
            ...
            <main>
                <div className="mx-auto max-w-full mx-8 py-6 sm:px-6 lg:px-8 flex flex-col border-4 border-dashed rounded-3xl border-gray-200 mx-4 md:mx-16 px-4">
                    <div className="flex flex-row rounded-lg max-h-24">
                        <h1 className="text-2xl md:text-3xl font-bold tracking-tight text-gray-900 my-auto">Sebutkan How Might We Berdasarkan Pain & Gain!</h1>
