            ...
            <div className="min-w-full mx-auto">
                <div className="bg-white shadow-md border border-gray-200 rounded-lg md:mx-12 p-4 sm:p-4 lg:p-8 dark:bg-gray-800 dark:border-gray-700">
                    <form className="space-y-6"
                        ...
                        <h3 className="text-xl font-medium text-gray-900 dark:text-white">Masuk ke IdeaRail</h3>
                        <div>
                        ...
                        <div className="flex items-start">
                            <button className="text-sm text-blue-700 hover:underline ml-auto dark:text-blue-500">Lupa password?</button>
                        </div>
                        <button type="submit"
                            className={
                        ...
                        <div className="text-sm font-medium text-gray-500 dark:text-gray-300">Belum punya akun?
                            <Link to="/register" className="text-blue-700 hover:underline dark:text-blue-500"> Buat disini</Link>
                        </div>
                    </form>
                </div>
            </div>
